      ...
      {open && (
        ...
        >
          <motion.div
            ...
            transition={dialogTransition}
            className="w-full max-w-[520px] rounded-2xl bg-white p-4 shadow-xl dark:bg-[#121212] md:p-5"
          >
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-2xl font-semibold text-[#1F1E1F] dark:text-white">
                Change password
              </h3>
              <button
                type="button"
                ...
                className="inline-flex size-7 cursor-pointer items-center justify-center rounded-full text-[#1F1E1F] transition-colors hover:bg-[#F3F4F6] dark:text-white dark:hover:bg-white/10"
              >
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} noValidate className="space-y-4">
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <button
                            ...
                            className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-[#6F7680] transition-colors hover:text-[#1565C0] dark:text-[#A3ACB9] dark:hover:text-white"
                          >
                            <HugeiconsIcon
                ...
                <div className="grid grid-cols-1 gap-2 pt-1 sm:grid-cols-2">
                  <Button
                    ...
                    variant="secondary"
                    onClick={onClose}
                    className="h-10 cursor-pointer border border-[#F3F4F6] bg-[#F3F4F6] text-sm font-medium text-[#1F1E1F] hover:bg-[#E7EAEE] dark:border-[#25292E] dark:bg-white/10 dark:text-white dark:hover:bg-white/15"
                  >
                    Cancel
                  </Button>
