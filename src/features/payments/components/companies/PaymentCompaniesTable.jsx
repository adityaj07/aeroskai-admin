...
export const PaymentCompaniesTable = ({ companies = [], meta, onIssueRefund }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 border-t border-[#EEF1F4] px-4 py-3 text-xs text-[#6F7680] dark:border-[#25292E] dark:text-[#9AA2AD] sm:flex-row sm:items-center sm:justify-between">
        <p>
