...
export const SubscriptionCard = ({ subscription }) => {
  ...
  return (
    ...
    >
      <p className="text-[28px] font-semibold text-[#0C1014] dark:text-white">{subscription.seats} Seats</p>
      <p className="text-xs text-[#6F7680] dark:text-[#A9B0BA]">{subscription.inUse} of {subscription.seats} seats in use</p>
      <Progress
        value={usage}
      ...
      <div className="grid grid-cols-2 gap-4 text-xs text-[#6F7680] dark:text-[#A9B0BA]">
        <div>
          <p>Start Date</p>
          <p className="text-[#0C1014] dark:text-white">{subscription.startDate}</p>
        </div>
        <div>
          <p>End Date</p>
          <p className="text-[#0C1014] dark:text-white">{subscription.endDate}</p>
        </div>
      </div>
    </AdminSectionCard>
  )
