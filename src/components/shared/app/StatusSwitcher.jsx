export const StatusSwitcher = ({ statuses, selectedStatus, onStatusChange }) => {
  return (
    <div className="overflow-x-auto">
      <div className="flex min-w-max items-center gap-4 border-b border-[#EEF1F4] pt-3 dark:border-white/10">
        {statuses.map((status) => {
          ...
          return (
            <button
              ...
              className={`min-w-18 shrink-0 whitespace-nowrap border-b-2 pb-2 text-center text-xs transition-colors ${
                isActive
