...
export const AdminSectionCard = ({
  ...
  return (
    <motion.section
      ...
      className={clsx(
        'dark:bg-background rounded-xl border border-[#F3F4F6] bg-white dark:border-white/10',
        className
      )}
    >
      {/* HEADER */}
      <div className="flex items-start justify-between gap-4 px-4 pt-4 md:px-5 md:pt-5">
        <div className="min-w-0">
          <h2 className="text-[14px] font-semibold text-[#6F7680] dark:text-white">{title}</h2>
      ...
      {/* SEPARATOR */}
      <Separator className="mt-4 h-px bg-[#E5E7EB] dark:bg-white/10" />
